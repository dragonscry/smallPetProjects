...
class ArryayModificationViewModel: ObservableObject {
...
//            user.isVerified && user.points > 50
//        })
        //map
...
//        let map = dataArray.compactMap({$0.name})
    ...
    func getUsers() {
        ...
        let user4 = UserModel(name: "Tom", points: 53, isVerified: false)
        let user5 = UserModel(name: "Samantha", points: 50, isVerified: true)
        let user6 = UserModel(name: "Paul", points: 35, isVerified: false)
        let user7 = UserModel(name: "Sarah", points: 75, isVerified: true)
        let user8 = UserModel(name: nil, points: 15, isVerified: false)
        let user9 = UserModel(name: "Steve", points: 34, isVerified: false)
        let user10 = UserModel(name: "Amanda", points: 2332, isVerified: true)
...
struct ArraysBootcamp: View {
    ...
    @StateObject var vm = ArryayModificationViewModel()
